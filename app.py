...
def exibir_dados_usuario(cliente):
...
def atualizacao_de_dados_do_usuario(cliente):
...
# CRUD.
solicitando_dados_usuario()

#
exibir_dados_usuario(Cliente)


# U - Update - UPDATE - Atualizar
atualizacao_de_dados_do_usuario(cliente)
# R - Read - SELECT - Consulta
print("\nExibindo dados de todos os clientes.")
lista_clientes = session.query(Cliente).all()
